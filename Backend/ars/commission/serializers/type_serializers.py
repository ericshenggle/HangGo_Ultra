...
from ars.models import  CommissionType
from ars.user.serializers import *
from drf_extra_fields.fields import Base64ImageField

class Commission_Type_Serializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        commissionType = CommissionType.objects.get_or_create(**validated_data)[0]
    ...
    def update(self, instance, validated_data):
        ...
        #2,返回数据
        commissionType = CommissionType.objects.get(id=instance.id)
        return commissionType
